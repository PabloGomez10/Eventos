...
tituloDelta.innerHTML = "Delta Informatica 2.0"


let bCar = document.getElementsByClassName("bCar")
for (let i = 0; i < bCar.length; i++) {
    bCar[i].addEventListener("click", function () {
        this.innerHTML = "Agregado al carrito"
        this.style.color = "white"
        this.style.backgroundColor = "#6b0219"


        bCar[i].addEventListener("mouseout", function () {
